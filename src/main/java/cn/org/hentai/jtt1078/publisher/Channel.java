...
public class Channel {
    ...
    public void writeVideo(long sequence, long timeoffset, int payloadType, byte[] h264) {
        ...
        // Normalize to 4-byte start code. JTT1078 devices often send raw NAL units
        // without any start code, or with a 3-byte start code. readNalu() uses
        // start codes as NALU delimiters and FlvEncoder expects nalu[4] to be the
        // NAL header byte (i.e. a preceding 4-byte start code is mandatory).
        int scLen = 0;
