...
public class Jtt1078Handler extends SimpleChannelInboundHandler<Packet> {
    ...
    private final String streamTypePrefix;

    public Jtt1078Handler(String streamTypePrefix) {
        this.streamTypePrefix = streamTypePrefix;
    }
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Packet packet) throws Exception {
        ...
        String tag = streamTypePrefix + "-" + sim + "-" + channel;
